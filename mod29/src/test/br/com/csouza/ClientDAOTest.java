...
public class ClientDAOTest {
	...
	public void updateTest() throws SQLException, WithoutTableName {
		...
		final Client findedClient = this.dao.findByCPF(c3.getCpf());
				
		// Atualizando o registro
		findedClient.setSurname("Vieira");
		final int result = this.dao.update(findedClient);
		Assert.assertEquals(1, result);
		
		// Buscando novamente pelo registro
		final Client findedClient2 = this.dao.findByCPF(c3.getCpf());
		Assert.assertEquals("Vieira", findedClient2.getSurname());
