...
public class ClientServiceTest {
    ...
    public ClientServiceTest() {
        this.service = new ClientService(new ClientDAOMock());
    }
    ...
    public void storeTest() throws Exception {
        ...
        boolean r1 = this.service.store(c1);
    ...
    public void showTest() throws Exception {
        ...
        this.service.store(c1);
        this.service.store(c2);
        this.service.store(c3);
        this.service.store(c4);
        this.service.store(c5);
        this.service.store(c6);

        // Buscando por um único cliente
        final Client client1 = this.service.show(4L);
        final Client client2 = this.service.show(2L);
    ...
    public void indexTest() throws Exception {
        ...
        Assert.assertEquals(6, this.service.index().size());
    }
    ...
    public void updateTest() throws Exception {
        ...
        final boolean r1 = this.service.update(5L, newData);
        final Client client = this.service.show(5L);
    ...
    public void destroyTest() throws Exception {
        ...
        final boolean r2 = this.service.destroy(3L);

        Assert.assertTrue(r1);
        Assert.assertFalse(r2);
        Assert.assertEquals(5, this.service.index().size());
    }
}
